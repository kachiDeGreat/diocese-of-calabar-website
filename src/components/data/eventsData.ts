...
export const eventsData: EventData[] = [
  ...
  },
  {
    ...
    category: "Sermons",
    content: [
      "Easter is the cornerstone of the Christian faith. It marks the victorious resurrection of our Lord Jesus Christ from the dead, conquering sin and death once and for all.",
      "As we gather this year, let us remember the profound sacrifice made on the cross and the glorious freedom secured through the empty tomb. It is a time for reconciliation, not just with God, but with our fellow brethren.",
      "Join us across all Archdeaconries as we lift our voices in praise. Special thanksgiving services will be held, and families are encouraged to participate fully in the week-long activities leading up to Resurrection Sunday.",
    ],
  },
  {
    id: 4,
    ...
    category: "Messages",
    content: [
      "Beloved in Christ, as we wave our palm branches today, we are reminded of Jesus' triumphant entry into Jerusalem. However, this triumph was not of earthly royalty, but of divine humility.",
      "The crowd shouted 'Hosanna!', yet days later, the cries turned to 'Crucify Him!'. This Palm Sunday, I urge every member of the Diocese to reflect on the steadfastness of our faith. Are we only followers in times of joy, or do we stand by the cross in times of trial?",
      "Let this holy week be a period of deep introspection, fasting, and renewed dedication to the teachings of our Savior.",
    ],
  },
  {
    id: 5,
    ...
    category: "Events",
    content: [
      "Motherhood is a divine calling, marked by unending grace, sacrifice, and strength. Today, the Diocese of Calabar honors all mothers, grandmothers, and spiritual mothers who have nurtured the next generation.",
      "The Mothers' Union and Women's Guild have been the backbone of many of our Diocesan achievements. Their fervent prayers and tireless service continue to uplift our parishes.",
      "We pray for God's continued blessings, health, and wisdom upon all our mothers as they guide their homes in the way of the Lord.",
    ],
  },
  {
    id: 6,
    ...
    category: "Youth",
    content: [
      "The future of the Church lies in the hands of our youth. To equip them for the challenges of tomorrow, the Diocese hosted a 3-day Empowerment and Leadership Conference.",
      "Hundreds of young people from various Archdeaconries gathered to learn about Christian leadership, entrepreneurship, and maintaining their faith in a digital world.",
      "Guest speakers included prominent business leaders and seasoned clergy who shared practical insights on balancing professional ambitions with a strong spiritual foundation.",
    ],
  },
  {
    id: 7,
    ...
    category: "Outreach",
    content: [
      "Faith without works is dead. Putting our faith into action, the Diocese recently concluded a massive community outreach program in the rural areas of our state.",
      "Medical supplies, food, and educational materials were distributed to hundreds of families. More importantly, the gospel of Jesus Christ was shared, bringing hope to the marginalized.",
      "We thank all the volunteers and donors who made this initiative possible and urge everyone to continue supporting the Diocesan Social Justice programs.",
    ],
  },
];
